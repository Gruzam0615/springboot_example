package com.gruzam0615.jpaboard.board.service;
...
import com.gruzam0615.jpaboard.board.repository.BoardRepository;
...
public class BoardService implements BoardRepository {
    ...
    public <S extends Board> S save(S entity) {
        entity.setBoardCreatedDate(LocalDateTime.now());
        entity.setBoardModifiedDate(LocalDateTime.now());
        return boardRepository.save(entity);
    }

    @Transactional
    public Board updateBoard(Board board) {
        Board b = getReferenceById(board.getBoardIdx());
